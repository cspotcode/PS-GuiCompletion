...
**This project has moved to https://github.com/nightroman/PS-GuiCompletion** The published module is the same GuiCompletion. It is developed by [@nightroman](https://github.com/nightroman) starting from v0.9.0.
